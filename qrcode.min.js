/**
 * QRCode for JavaScript (Standalone Offline Library)
 * Davidshimjs QRCode modified for pure local browser execution
 */
var QRCode;
(function(){
...
QRCode=function(el,options){
    ...
    if(typeof options==="string"){this._htOption.text=options;}else if(options){for(var i in options){this._htOption[i]=options[i];}}
